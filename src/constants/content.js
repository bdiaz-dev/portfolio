...
export const content = {
  header: {
    titles: {
      es: 'Desarrollador Frontend & Videojuegos Indie',
      en: 'Frontend Developer & Indie Games'
    }
  },
  about: {
    title: {
  ...
  projects: {
    ...
    jobs: [
      // ------ WEATHERAPP2 ------
      {
        title: 'WeatherApp2',
        text: {
          es: 'Prueba técnica de consulta de clima de 3 ciudades preestablecidas para muestra de habilidades.',
          en: 'Technical test for weather consultation of 3 pre-set cities to showcase skills.'
        },
        description: {
          es: [
      ...
      // ------ REACTDEE ------
      {
        title: 'ReactDee',
        text: {
          es: 'Componentes para aplicaciones React. Simples, faciles y listos para usar.',
          en: 'Simply, easy, and ready for use React Components for your apps.'
        },
        description: {
          es: [
      ...
      // ------ ONA GAMES ------
      {
        title: 'Ona Games',
        text: {
          es: 'La pagina web de mi desarrolladora Indie de Videojuegos.',
          en: 'The website of my Indie Game Development studio.'
        },
        description: {
          es: [
      ...
      // ------ EDITORIAL DINAV ------
      {
        ...
        text: {
          es: 'Aplicación para hacer lista de lectura sobre Editorial inventada.',
          en: 'Application for creating a reading list for a fictional publishing house.'
        },
        description: {
          es: [
      ...
      //  ------ WEATHER NOW ------
      {
        title: 'Weather Now',
        text: {
          es: 'Una aplicacion de clima escrita en JavaScript puro.',
          en: 'A weather application written in pure JavaScript.'
        },
        description: {
          es: [
      ...
      // ------ BLOCK SURVIVOR ------
      {
        ...
        text: {
          es: 'Juego para Android tipo Arcade 80s hecho con Godot.',
          en: 'An arcade-style 80s game for Android created using Godot.'
        },
        description: {
          es: [
